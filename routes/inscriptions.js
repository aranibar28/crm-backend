...
router.get("/read_inscriptions_dates/:employee/:from?/:to?", [validateJWT], ctrl.read_inscriptions_dates);
...
router.get("/accept_inscription/:id", [validateJWT], ctrl.accept_inscription);
router.get("/pass_inscription/:id", [validateJWT], ctrl.pass_inscription);
